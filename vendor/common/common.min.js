...
if (!function(p) {
    p.extend({
        browserSelector: function() {
            ...
            !window.ActiveXObject && "ActiveXObject"in window ? p("html").removeClass("gecko").addClass("ie ie11") : (p("body").hasClass("dark") && p("html").addClass("dark"),
...
$(window).on("load", function() {
    setTimeout(function() {
        ...
        $(t).get(0) && ($("a[href$='" + window.location.hash + "']").is("[data-hash-offset]") ? e = parseInt($("a[href$='" + window.location.hash + "']").first().attr("data-hash-offset")) : $("html").is("[data-hash-offset]") && (e = parseInt($("html").attr("data-hash-offset"))),
...
function(e) {
    e(".thumb-info-floating-caption").get(0) && (e(".thumb-info-floating-caption").on("mouseenter", function() {
        e(".thumb-info-floating-caption-title").get(0) || (e(".body").append('<div class="thumb-info-floating-caption-title">' + e(this).data("title") + "</div>"),
        e(this).data("type") && e(".thumb-info-floating-caption-title").append('<div class="thumb-info-floating-caption-type">' + e(this).data("type") + "</div>").css({
            "padding-bottom": 22
        }),
...
function(t) {
    ...
    n.fn.countTo = function(s) {
        return this.each(function() {
            ...
            e && "object" != typeof s || (e && e.stop(),
            t.data("countTo", e = new a(this,o))),
            e[i].call(e)
        })
    }
}),
    ...
    H.fn.visible = function(t, e, o, i) {
        if (!(this.length < 1)) {
            var s = 1 < this.length ? this.eq(0) : this
              ...
              , d = a.outerHeight()
              , p = (o = o || "both",
            !0 !== e || l.offsetWidth * l.offsetHeight);
...
function(t) {
    ...
    u._apply = function(t, e) {
        ...
        r.css("display", "block"),
        n.byRow && !n.target && (o.each(function() {
            var t = l(this)
              , e = t.css("display");
        ...
        l.each(i, function(t, e) {
            ...
            o.each(function() {
                var t = l(this)
                  , e = 0;
                n.target && t.is(n.target) || ("border-box" !== t.css("box-sizing") && (e += c(t.css("border-top-width")) + c(t.css("border-bottom-width")),
...
function(t) {
    ...
    h.fn.waitForImages = function() {
        var n, a, r, e, l = 0, c = h.Deferred(), d = this, p = [], o = h.waitForImages.hasImageProperties || [], i = h.waitForImages.hasImageAttributes || [], u = /url\(\s*(['"]?)(.*?)\1\s*\)/g;
        if (h.isPlainObject(arguments[0]) ? (e = arguments[0].waitForAll,
        r = arguments[0].each,
        a = arguments[0].finished) : e = 1 === arguments.length && "boolean" === h.type(arguments[0]) ? arguments[0] : (a = arguments[0],
        r = arguments[1],
        arguments[2]),
        a = a || h.noop,
        r = r || h.noop,
...
function(c) {
    fontSpy = function(t, e) {
        ...
        var l = function() {
            ...
            a.remove()) : n.timeOut < 0 ? (o.addClass("no-" + n.fontClass),
            n && n.failure && n.failure(),
            n.callback(new Error("FontSpy timeout")),
            a.remove()) : (setTimeout(l, n.delay),
            n.timeOut = n.timeOut - n.delay)
        };
        l()
    }
}(jQuery),
            ...
            if (!d) {
                ...
                for (var t = [], e = 0, o = c.length; e < o; e++) {
                    ...
                    if (s) {
                        ...
                        l.activeClass && i.addClass(l.activeClass)) : a <= r ? (i.css({
                            left: "",
                            top: a - s.parentTop + s.pad.top
                        }).css("position", "absolute"),
                        l.activeClass && i.addClass(l.activeClass)) : (i.css({
                            position: "",
                            top: "",
                            left: ""
                        }),
...
jQuery(document).ready(function(a) {
    ...
    function h(t) {
        ...
        if (t.parents(".word-rotator").hasClass("type")) {
            ...
            t.parents(".word-rotator").hasClass("clip") ? t.parents(".word-rotator-words").stop(!0, !0).animate({
                width: "2px"
            }, u, function() {
                g(t, e),
                f(e)
    ...
    function f(t, e) {
        t.parents(".word-rotator").hasClass("type") ? (m(t.find("i").eq(0), t, !1, e),
        ...
        }) : (t.parents(".word-rotator-words").stop(!0, !0).css("width", t.outerWidth() + 10),
        h(t)))
    }
    function m(t, e, o, i) {
    ...
    function g(t, e) {
        if (t.removeClass("is-visible").addClass("is-hidden"),
    ...
    e.fn.hover3d = function(t) {
        ...
        return this.each(function() {
            ...
            t.on("mouseenter", function() {
                return p.addClass(h.hoverInClass + " " + h.hoverClass),
                currentX = currentY = 0,
            ...
            t.on("mouseleave", function() {
                return p.addClass(h.hoverOutClass + " " + h.hoverClass),
                p.css({
                    perspective: h.perspective + "px",
                    transformStyle: "preserve-3d",
...
!function(o) {
    var t = {
        ...
        build: function() {
            ...
            o(window).height() - o(".header-body").height() < t ? (o("#footer").removeClass("footer-reveal"),
            o("body").css("margin-bottom", 0)) : (o("#footer").addClass("footer-reveal"),
