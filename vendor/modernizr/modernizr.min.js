 ...
 * https://modernizr.com/download/?-backgroundcliptext-boxshadow-csstransforms3d-csstransitions-history-svg-video-domprefixes-mq-prefixed-prefixes-setclasses-shiv-testallprops-teststyles !*/
 !function(e, t, n) {
    ...
    function c(e, n, r, o) {
        var a, i, c, u, f = "modernizr", d = s("div"), p = l();
        if (parseInt(r, 10))
            for (; r--; )
                c = s("div"),
                c.id = o ? o[r] : f + (r + 1),
    ...
    function g(e, t, n, o, a) {
        ...
        return r(t, "string") || r(t, "undefined") ? v(s, t, o, a) : (s = (e + " " + _.join(i + " ") + i).split(" "),
        d(s, t, n))
    }
    function y(e, t, r) {
        return g(e, n, n, t, r)
    ...
    w || !function(e, t) {
        ...
        function c(e) {
            e || (e = t);
            var r = a(e);
            return !S.shivCSS || u || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),
            f || l(e, r),
            e
        }
    ...
    x.mq = k;
    var z = (x.testStyles = c,
    x._config.usePrefixes ? T.split(" ") : []);
    x._cssomPrefixes = z;
    var j = function(t) {
        var r, o = b.length, a = e.CSSRule;
    ...
    x.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? j(e) : (-1 != e.indexOf("-") && (e = i(e)),
        t ? g(e, t, n) : g(e, "pfx"))
    }
    ;
    x.testAllProps = y,
